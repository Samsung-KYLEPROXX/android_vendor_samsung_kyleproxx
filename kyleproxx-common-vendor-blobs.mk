...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/proprietary/etc/DiamondVoice_Filter_NB.txt:/system/etc/DiamondVoice_Filter_NB.txt \
    $(LOCAL_PATH)/proprietary/etc/DiamondVoice_Filter_WB.txt:/system/etc/DiamondVoice_Filter_WB.txt \
    $(LOCAL_PATH)/proprietary/etc/DiamondVoice_NB.txt:/system/etc/DiamondVoice_NB.txt \
    $(LOCAL_PATH)/proprietary/etc/DiamondVoice_SF_Filter_NB.txt:/system/etc/DiamondVoice_SF_Filter_NB.txt \
    $(LOCAL_PATH)/proprietary/etc/DiamondVoice_SF_Filter_WB.txt:/system/etc/DiamondVoice_SF_Filter_WB.txt \
    $(LOCAL_PATH)/proprietary/etc/DiamondVoice_WB.txt:/system/etc/DiamondVoice_WB.txt \
    ...
    $(LOCAL_PATH)/proprietary/lib/modules/VoiceSolution.ko:/system/lib/modules/VoiceSolution.ko \
